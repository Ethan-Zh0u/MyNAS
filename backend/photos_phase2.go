...
type photosFeatureResponse struct {
	...
	DeviceAssetMappingRecovery bool `json:"deviceAssetMappingRecovery"`
	PhotoDelete                bool `json:"photoDelete"`
}
...
func (a *App) photosCapabilities(w http.ResponseWriter, r *http.Request) {
	...
	writeJSON(w, photosCapabilitiesResponse{
		...
		Features: photosFeatureResponse{
			...
			RemoteBrowsing:             true,
			ChangeFeed:                 true,
			DeviceAssetMappingRecovery: true,
			PhotoDelete:                true,
		},
